...
def main():
    ...
    playlist_url = "https://www.youtube.com/playlist?list=PLaNkJORnlhZnIE6kHYXJ5o6foVzPbFMNU"
    ...
    download_folder = "/Volumes/HezeSamsung/Lectures/ItalianQM"
    
    # Folder where the transcript text files will be stored.
    transcript_folder = "/Volumes/HezeSamsung/Lectures/ItalianQM"
